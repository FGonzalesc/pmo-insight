    ...
    <header className="border-b border-slate-200/80 bg-white">
      ...
      <div className="flex flex-col gap-5 px-5 py-6 sm:px-8 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-3xl">
          ...
          <div className="mt-3 h-1 w-40 rounded-full" style={{ background: brandGradient }} />
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="inline-flex w-fit items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-xs font-semibold text-slate-600 shadow-sm">
            <CalendarDays className="h-4 w-4 text-[#2F80ED]" aria-hidden />
            Mes de corte: {nombreMes(mesCorte)}
          </div>
          <button
            className="inline-flex items-center gap-2 rounded-lg px-4 py-2.5 text-xs font-semibold text-white shadow-sm"
